...
$REGION="us-south";
$ACTIVE_RESERVATIONS_FILE="activeReservations.txt";
...
print "Creating activeReservations.txt file.\n";

#empty the file (probably a way to do this directly in perl)
`> $ACTIVE_RESERVATIONS_FILE`;
foreach my $user (@users)
{
    `echo $user >> $ACTIVE_RESERVATIONS_FILE`;
}
