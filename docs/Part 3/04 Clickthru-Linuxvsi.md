...
1. Open the following link and then click the play ![image](https://github.com/user-attachments/assets/67789db8-fd6d-4d68-a26b-3a1d6c0b7e97) button to begin the demonstration.
    ...
    **Click through demonstration:** <a href="https://ibm.github.io/SalesEnablement-PowerVS-L3/includes/Provision-LinuxVM/index.html" target ="_blank">Create an IBM Power Virtual Server Instance - Linux</a>
...
47. Toggle **Public networks** to **On**.
48. Click **Attach existing network +**.
